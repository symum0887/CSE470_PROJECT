          ...
          <section class="section background-white">
            ...
            <div class="s-12 m-12 l-4 center">
              ...
              <form method="post" enctype="multipart/form-data" name="contactForm" class="customform" method="post">
                ...
                <div class="s-12"> 
                  <input name="carmodel" class="subject" placeholder="Car model"  type="text" required>
                  <p class="subject-error form-error">Please enter a title.</p>
                </div>
                <div class="s-12">
                ...
                <div class="s-12"> 
                  <input name="price" class="subject" placeholder="Price" type="number" required>
                  <p class="subject-error form-error">Please enter a price.</p>
                </div>
