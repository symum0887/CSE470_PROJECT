    ...
    <script type="text/javascript" src="<?=ASSETS?>medion/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>medion/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>medion/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>medion/js/template-scripts.js"></script> 
  </body>
</html>