                ...
                <a class="image-with-hover-overlay image-hover-zoom" href="<?=ROOT.'single_post/' .$row->url_address; ?>/" title="Portfolio Image">
                  <div class="image-hover-overlay background-primary"> 
                    <div class="image-hover-overlay-content text-center padding-2x">
                      ...
                      <p class="text-white text-size-14 margin-bottom-20">Model:<?=$row->carmodel?></p>
                      <p class="text-white text-size-14 margin-bottom-20"><?=$row->description?></p>  
                      <p class="text-white text-size-14 margin-bottom-20">Price: $<?=$row->price?></p>
                      <h3 class="text-white text-size-14 margin-bottom-20">Click here to Buy</h3>
                    </div> 
                  </div> 
